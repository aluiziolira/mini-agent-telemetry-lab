...
class SpanIngestSerializer(serializers.Serializer[object]):
    ...
    parent_span_id = serializers.UUIDField(required=False, allow_null=True, default=None)
    attributes = serializers.JSONField(required=False, default=dict)
    agent_name = serializers.CharField(required=False, default="unknown", max_length=100)
